...
class RClone:
    ...
    def __init__(self, cfg: str, logger: Logger) -> None:
    ...
    def copy(
        self, source: str, dest: str, flags: Optional[List[str]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def listremotes(self, flags: Optional[List[str]] = None) -> Dict[str, Any]:
        """
    ...
    def ls(self, dest: str, flags: Optional[List[str]] = None) -> Dict[str, Any]:
        """
    ...
    def lsjson(self, dest: str, flags: Optional[List[str]] = None) -> Dict[str, Any]:
        """
    ...
    def delete(self, dest: str, flags: Optional[List[str]] = None) -> Dict[str, Any]:
        """
